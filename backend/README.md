...
## Project Structure
    ...
    ├── fragrant_waterfall_31506  # Django project configurations
...
1. Clone this repo and `cd fragrant_waterfall_31506`
...
2. Clone this repo and `cd fragrant_waterfall_31506`
